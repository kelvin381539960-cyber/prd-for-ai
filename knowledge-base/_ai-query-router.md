...
6. 如需核验来源，再读 `archive/historical-prd/`、`reference-data/` 或 `external-docs/` 中的对应来源文件
```
...
旧 correction / refinement / final review 文件
kyc/wallet-kyc.md
```
...
| 问题类型 | 主事实文件 | 必须联动读取 |
|---|---|---|
| Deposit / 到账 / 风险拦截 / WalletConnect | `wallet/deposit.md` | `integrations/dtc/_index.md`、`integrations/walletconnect/_index.md`、`common/notification.md`、`common/errors.md`、`transaction/status-model.md`、`knowledge-gaps.md`、`_system-boundary.md` |
| KYC / Account Opening / Sub Account / 准入 | `kyc/account-opening.md` | `integrations/aai/_index.md`、`integrations/dtc/_index.md`、`common/notification.md`、`knowledge-gaps.md`、`_system-boundary.md` |
| Card 交易资金回退 / refund / reversal / Top-up / deposit | `card/transaction.md` | `transaction/reconciliation.md`、`common/errors.md`、`knowledge-gaps.md`、`_system-boundary.md` |
| Card 交易列表 / 交易详情 | `card/transaction-detail.md` | `transaction/history.md`、`transaction/detail.md`、`transaction/status-model.md`、`common/notification.md`、`knowledge-gaps.md`、`_system-boundary.md` |
| Transaction 状态 / ID 串联 / 资金追踪 | `transaction/status-model.md` 或 `transaction/reconciliation.md` | `transaction/history.md`、`transaction/detail.md`、`card/transaction.md`、`card/transaction-detail.md`、`wallet/deposit.md`、`knowledge-gaps.md`、`_system-boundary.md` |
| PRD 写作 / 知识库修改 | 对应模块事实文件 | `prd-template/standard-prd-template.md`、`knowledge-base/_kb-ingestion-process.md`、`requirements/_index.md`、`knowledge-gaps.md`、必要时读 `_system-boundary.md` |
...
| KYC | Account Opening / KYC 开户、Sub Account、业务准入边界 |
| Security | 身份认证、OTP、Passcode、生物识别、人脸认证、密码策略 |
...
| Card Manage | active | 读取 `card/manage/_index.md` 及子功能文件 |
| Card Transaction | active / partial | 卡交易资金回退在 `card/transaction.md`；资金追踪与对账缺口查 `transaction/reconciliation.md` 与 ALL-GAP |
| Card Transaction Detail | active / partial | 卡交易列表和详情展示在 `card/transaction-detail.md`；全局交易状态和对账查 `transaction/` 与 ALL-GAP |
...
|---|---|---|---|
| 当前知识库如何使用 | `_ai-query-router.md` | 模块 `_index.md`、`_kb-ingestion-process.md` | 旧实施计划、旧会话交接、旧 review 过程文件 |
...
1. 默认读取建设期过程文件、review 文件、correction plan、implementation log、decision log 或临时 checklist。
