...
| Deposit 总逻辑 | `wallet/deposit.md` | `integrations/dtc/_index.md`、`integrations/walletconnect/_index.md`、`common/notification.md`、`common/errors.md`、`_system-boundary.md` | `wallet/receive.md` |
...
| Errors / 错误处理 | `common/errors.md` | `integrations/walletconnect/_index.md`、`wallet/deposit.md`、`card/card-transaction-flow.md`、`kyc/account-opening.md`、`knowledge-gaps.md` | 自行补错误码表 |
