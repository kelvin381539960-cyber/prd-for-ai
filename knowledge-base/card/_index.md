...
| Card Status & Fields | [card-status-and-fields.md](./card-status-and-fields.md) | 未开始 | 卡状态、卡类型、品牌、费用类型、自动扣款字段和操作限制；应先于 Card Home 收口 | AIX Card V1.0【Application】 / 3-4；AIX Card manage模块需求V1.0 / 6.1-6.4 |
