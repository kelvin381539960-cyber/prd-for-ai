...
version: "3.0"
status: active
source_doc: knowledge-base/card/application.md；knowledge-base/card/card-home.md；knowledge-base/card/manage/_index.md；knowledge-base/card/transaction.md；knowledge-base/changelog/knowledge-gaps.md；knowledge-base/_system-boundary.md
source_section: Card runtime structure；Card Application；Card Home；Card Manage；Card Transaction；ALL-GAP；system boundary
...
Card 模块按原始 PRD 的产品边界拆分为：申卡、Card Home、Card Manage、Card Transaction。

Card 目录不再把 Manage、Transaction 和全局 Transaction & History 混在同一个文件里。
...
| `card/transaction.md` | active | Card 交易通知、自动归集、Card Home 交易展示边界 |
...
| `AIX Card交易【transaction】.docx` | `card/transaction.md` | Card 交易主事实源 |
| `AIX APP V1.0【Transaction & History】 (1).docx` | `transaction/*` | 全局交易历史、详情、状态、对账；Card 只引用边界 |
...
| Card 交易通知、自动归集、Transfer Balance to Wallet、Card 最近交易入口 | `card/transaction.md` |
| 卡交易历史 / 详情 / 状态 / 对账 | `transaction/history.md`、`transaction/detail.md`、`transaction/status-model.md`、`transaction/reconciliation.md` |
