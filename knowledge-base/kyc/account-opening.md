      ...
      <ul>
        ...
        <li><strong>重试后结果</strong>：
          <ul>
            ...
            <li>查询返回失败：进入 Face Failed 或对应错误处理；细则见 <a href="#410-face-failed-page">4.10 Face Failed Page</a>。</li>
          </ul>
        </li>
      </ul>
    </td>
  ...
  <tr>
    ...
    <td valign="top">
      ...
      <ul>
        ...
        <li><strong>国家二次判断不符合规则</strong>：进入 waitlist 或展示对应错误处理；拦截展示见 <a href="#4111-拦截waitlist">4.11.1 拦截：Waitlist</a>。</li>
      </ul>
