...
| 问题 | 结论 |
|---|---|
| GAP-KYC-SG-001：SG 是否支持 DTC POA upload-file 的 `countryOfResidence` | ✅ 支持 |
| GAP-KYC-PHONE-001：手机号未绑定时完整处理流程 | 未绑定手机号需先去绑定，不允许继续 KYC 流程 |
| GAP-KYC-POA-001：POA 有效期 | 6 个月内有效 |
| GAP-KYC-POA-002：POA continue 后支持国家进入哪个页面 | 提交成功进入 Submission Success |
| GAP-KYC-POA-003：POA failed 时 DTC 更新哪个字段 | `proofOfAddressVerifyStatus` |
| GAP-KYC-NOTIFICATION-001：KYC 通知规则来源与模板 | 见 [system-notification-content.xlsx](https://github.com/kelvin381539960-cyber/prd/blob/main/reference-data/notification/system-notification-content.xlsx) |
