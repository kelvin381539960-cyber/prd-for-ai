...
version: "2.0"
status: active
source_doc: knowledge-base/kyc/wallet-kyc.md；knowledge-base/common/aai.md；knowledge-base/changelog/knowledge-gaps.md；knowledge-base/_system-boundary.md；用户确认结论 2026-05-02
source_section: KYC 使用态目录结构；AAI Dependency；ALL-GAP 总表；system-boundary
...
| 旧路径 | 当前处理 |
|---|---|
| `wallet/kyc.md` | 不作为运行时事实源；主事实源为 `kyc/wallet-kyc.md` |
...
1. 查询 Wallet KYC 或钱包开户准入时，读 `kyc/wallet-kyc.md`。
2. 查询 AAI 外部依赖时，读 `common/aai.md`。
3. 查询未确认项时，读 `knowledge-base/changelog/knowledge-gaps.md`。
4. 查询责任边界时，读 `knowledge-base/_system-boundary.md`。
5. 不默认读取 moved notice、stage-review 或历史 checklist 文件。
