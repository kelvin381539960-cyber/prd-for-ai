...
- (Ref: archive/historical-prd/security/AIX Security 身份认证需求V1.0 (1).docx / 7.4 活体有效期说明 / V1.0)
- (Ref: archive/historical-prd/security/AIX Security 身份认证需求V1.0 (1).docx / 8.6 活体识别认证 / V1.0)
