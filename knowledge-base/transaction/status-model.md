...
Card 交易状态与类型优先引用 `card/transaction.md` 和 `card/transaction.md`。
...
- (Ref: knowledge-base/card/transaction.md / Card Transaction Flow)
- (Ref: knowledge-base/card/transaction.md / Card status and fields)
