...
| 验收场景 | 验收标准 |
|---|---|
| 范围边界 | 只覆盖 Card / Wallet / Deposit Detail 已确认事实 |
...
9. Card balance 转 Wallet 的资金追踪链路已闭环。
10. `FIAT_DEPOSIT` 必然等同 GTR。
11. `CRYPTO_DEPOSIT` 必然等同 WalletConnect。
12. Deposit success 必然等同 Wallet `COMPLETED`。
...
![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image26.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:555_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image27.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:575_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image28.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:576_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image29.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:577_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image30.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:578_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image31.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:630_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image32.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:651_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image33.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:671_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image34.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:672_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image35.jpeg)

_Source: archive/legacy-prd/app/transaction-history/README.md:673_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image36.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:674_

![Transaction Details](../../archive/legacy-prd/app/transaction-history/assets/media/image37.png)

_Source: archive/legacy-prd/app/transaction-history/README.md:675_
