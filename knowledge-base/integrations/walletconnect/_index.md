...
| 项目 | 结论 | 来源 | 备注 |
|---|---|---|---|
| WalletConnect 当前归属 | Wallet Deposit 子路径 | Wallet Deposit v1.6 | 只作为 Deposit 外部集成边界维护 |
...
- (Ref: external-docs/dtc/Documentation dtc-nodejs-wallet-connect (ARCHIVE).docx / 1 Request Wallet Connect Token)
