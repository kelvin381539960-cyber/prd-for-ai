...
version: "1.0"
status: active
source_doc: archive/legacy-prd/wallet/deposit-send-swap/README.md；archive/legacy-prd/app/transaction-history/README.md
...
本文件用于收口原 `wallet/deposit.md` 的 SOURCE_GAP。规则来自 `archive/legacy-prd/wallet/deposit-send-swap/README.md` 的 6.2 钱包兑换 Swap Crypto、7.5 Get OTC Rate、7.6 OTC Exchange，并同步引用 Transaction Details 作为交易详情支撑证据。
...
- (Ref: archive/legacy-prd/wallet/deposit-send-swap/README.md / 6.2 钱包兑换 Swap Crypto)
- (Ref: archive/legacy-prd/wallet/deposit-send-swap/README.md / 7.5 Get OTC Rate)
- (Ref: archive/legacy-prd/wallet/deposit-send-swap/README.md / 7.6 OTC Exchange)
- (Ref: archive/legacy-prd/app/transaction-history/README.md / Swap Details)
...
![Swap](../../archive/legacy-prd/wallet/deposit-send-swap/assets/media/image23.png)

_Source: archive/legacy-prd/wallet/deposit-send-swap/README.md:503_

![Swap](../../archive/legacy-prd/wallet/deposit-send-swap/assets/media/image24.png)

_Source: archive/legacy-prd/wallet/deposit-send-swap/README.md:504_

![Swap](../../archive/legacy-prd/wallet/deposit-send-swap/assets/media/image25.png)

_Source: archive/legacy-prd/wallet/deposit-send-swap/README.md:505_

![Swap](../../archive/legacy-prd/wallet/deposit-send-swap/assets/media/image26.png)

_Source: archive/legacy-prd/wallet/deposit-send-swap/README.md:506_

![Swap](../../archive/legacy-prd/wallet/deposit-send-swap/assets/media/image30.png)

_Source: archive/legacy-prd/wallet/deposit-send-swap/README.md:571_

![Swap](../../archive/legacy-prd/wallet/deposit-send-swap/assets/media/image31.png)

_Source: archive/legacy-prd/wallet/deposit-send-swap/README.md:572_

### Swap Order

![Swap Order](../../archive/legacy-prd/wallet/deposit-send-swap/assets/media/image27.png)

_Source: archive/legacy-prd/wallet/deposit-send-swap/README.md:545_

![Swap Order](../../archive/legacy-prd/wallet/deposit-send-swap/assets/media/image28.png)

_Source: archive/legacy-prd/wallet/deposit-send-swap/README.md:546_

![Swap Order](../../archive/legacy-prd/wallet/deposit-send-swap/assets/media/image29.png)

_Source: archive/legacy-prd/wallet/deposit-send-swap/README.md:547_
