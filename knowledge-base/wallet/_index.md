...
version: "2.1"
status: active
source_doc: knowledge-base/wallet/deposit.md；knowledge-base/wallet/balance.md；knowledge-base/wallet/receive.md；knowledge-base/wallet/send.md；knowledge-base/transaction/history.md；knowledge-base/kyc/account-opening.md；knowledge-base/changelog/knowledge-gaps.md；knowledge-base/_system-boundary.md；decision-log/2026-05-02-deposit-active.md
...
Wallet 目录只承接钱包产品能力，不承接开户 / KYC 主事实，也不承接交易历史统一层：
...
| `wallet/receive.md` | deferred | 转译 Receive / 收款地址相关能力 | 与 Deposit 子路径关系待来源确认 |
...
| 原能力 | 当前主事实源 | 使用规则 |
|---|---|---|
| Wallet KYC / 钱包开户 | `kyc/account-opening.md` | 不从 Wallet 目录读取 KYC 主事实；旧 `kyc/wallet-kyc.md` 不再作为运行时入口 |
...
| Account Opening / KYC / 开户准入 | KYC 目录维护 | Wallet 目录不维护 KYC 主事实 | 见 `kyc/account-opening.md` |
...
2. 查询开户、KYC、Sub Account、`D-SUB-ACCOUNT-ID` 或 Wallet 能力准入时，读 `kyc/account-opening.md`。
...
6. 不默认读取 `kyc/wallet-kyc.md`、moved notice、stage-review、历史 checklist 或 migrated-reference 文件。
